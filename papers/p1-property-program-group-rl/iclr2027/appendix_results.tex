...
protocol. Raw@1 and pass@$k$ remain separate budget diagnostics. The older
direct-SMILES editing checkpoint reached zero strict
$\operatorname{Acc}_{\mathrm{all}}(.65)$ and therefore remains a diagnostic,
not the result assigned to the preregistered P4 rows.
