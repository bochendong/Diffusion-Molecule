...
candidates, supervised D3 reaches 43.35\% strict candidate accuracy. Applying
...
\begin{table}[t]
  ...
  MolEditRL; Any@20 asks whether a condition has at least one hit. D3 uses one
  frozen seed and exactly 20 raw candidates per condition.}
  ...
  \begin{tabular}{lrrrrr}
    ...
    D3 supervised & 97.38 & 43.35 & 57.60 & 76.52 & 92.51 \\
    D3 + Group-RL & \textbf{97.51} & \textbf{46.12} & 61.90 & \textbf{78.83} & \textbf{93.31} \\
...
candidate-level metrics. Our D3 rows use exactly 20 generated trajectories per
condition and are evaluated candidate-wise over the complete unranked pool.
...
ablation; D3 + Group-RL is the promoted editing operator. We omit FCD because
it is not part of our evaluation contract.

\input{moledit_table1.tex}

The per-task table exposes a heterogeneous gain. D3 + Group-RL is strongest on
...
MolEditRL under strict candidate-level accuracy after Group-RL, but not under
