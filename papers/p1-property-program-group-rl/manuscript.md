...
we introduce *Compositional Property Programs*, a direct molecular generation
framework that represents each design request as a variable-length program of
property targets, tolerances, and directions. The framework combines
