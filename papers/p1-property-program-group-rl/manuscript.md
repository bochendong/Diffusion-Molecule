...
programs during supervised training, while group-relative reinforcement
learning uses programmatically verifiable molecular-property feedback to
improve joint constraint satisfaction. All molecules are generated directly
by the model, without retrieval from an external molecular library, a molecular
...
combinations. Extensive experiments demonstrate that group-relative
post-training improves high-order and out-of-distribution control over
