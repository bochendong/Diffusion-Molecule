...
Curated **cores** (scaffolds) and **groups** (functional-group fragments) used during assembly are summarized in [learn/fragments-and-scaffolds.md](learn/fragments-and-scaffolds.md) (inventory + code pointers). Additional notes live under [learn/](learn/).
