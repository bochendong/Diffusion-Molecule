...
| `understanding-condition/` | [direct-smiles-denovo-v1-sampled-rerank.md](understanding-condition/direct-smiles-denovo-v1-sampled-rerank.md) | direct SMILES de novo v1 sampled rerank（待运行；无 candidate library） |
