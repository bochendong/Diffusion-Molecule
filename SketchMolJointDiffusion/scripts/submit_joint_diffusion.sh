...
export SKETCHMOL_JOINT_TOKENIZATION="${SKETCHMOL_JOINT_TOKENIZATION:-smiles_token}"
...
export SKETCHMOL_JOINT_DECODE_LENGTH_MODE="${SKETCHMOL_JOINT_DECODE_LENGTH_MODE:-free}"
