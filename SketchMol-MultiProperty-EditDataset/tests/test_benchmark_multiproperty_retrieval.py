...
def test_edit_latent_source_similarity_rerank_is_not_scaffold_limited():
    prop_count = len(benchmark.PROPERTY_COLUMNS)
    latent = np.zeros(prop_count * 4, dtype=np.float32)
    mw_idx = benchmark.PROPERTY_COLUMNS.index("MW")
    latent[mw_idx] = 200.0
    ...
    try:
        ...
        decoded = benchmark._decode_row(
            ...
            candidates=[
                {"smiles": "far", "scaffold": "other_a", "props": {"MW": 200.0}},
                {"smiles": "near_different_scaffold", "scaffold": "other_b", "props": {"MW": 200.0}},
            ],
            by_scaffold={"source_scaffold": [{"smiles": "far", "scaffold": "source_scaffold", "props": {"MW": 200.0}}]},
            ...
            edit_latent_source_similarity_weight=1.0,
