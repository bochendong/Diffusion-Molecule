...
def main() -> None:
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "hybrid_edit_policy_transform",
            "edit_policy_transform",
        ],
        default="retrieval",
    )
...
def _build_decoder(
    ...
    if decoder_mode in {"hybrid_edit_policy_transform", "edit_policy_transform"}:
        return EditPolicyTransformDecoder(
            train_smiles,
            train_targets,
            train_examples=train_examples,
            de_novo_latent_rerank_weight=de_novo_latent_rerank_weight,
            ...
            candidates_per_seed=generative_candidates_per_seed,
            novelty_bonus=generative_novelty_bonus,
            include_retrieval=decoder_mode == "hybrid_edit_policy_transform",
            include_mutation_fallback=decoder_mode == "hybrid_edit_policy_transform",
        )
...
def _decoder_label(decoder_mode: str, task_family: str) -> str:
    ...
    if "edit_policy_transform" in decoder_mode:
        return "property_guided_transform" if task_family == "de_novo" else "supervised_edit_policy_transform"
