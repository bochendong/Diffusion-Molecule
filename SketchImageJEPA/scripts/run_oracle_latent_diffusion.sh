...
export SKETCHIMAGE_ORACLE_SAMPLE_MULTIPLIER="${SKETCHIMAGE_ORACLE_SAMPLE_MULTIPLIER:-1}"
export SKETCHIMAGE_ORACLE_TEMPERATURE="${SKETCHIMAGE_ORACLE_TEMPERATURE:-0.9}"
export SKETCHIMAGE_ORACLE_TOP_P="${SKETCHIMAGE_ORACLE_TOP_P:-0.95}"
...
echo "  top_p=$SKETCHIMAGE_ORACLE_TOP_P"
...
"$PYTHON_BIN" -m sketchimage_jepa.oracle_latent_diffusion \
  ...
  --objective "$SKETCHIMAGE_ORACLE_OBJECTIVE" \
  ...
  --top-p "$SKETCHIMAGE_ORACLE_TOP_P" \
