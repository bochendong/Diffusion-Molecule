#!/usr/bin/env bash
# Run Phase 2A: JEPA planner latents decoded by a frozen Phase 1 oracle decoder.
...
RUN_NAME="${SKETCHIMAGE_RUN_NAME:-phase2_planned_decoder_2048_seed${SKETCHIMAGE_SEED:-7}}"
...
echo "SketchImage-JEPA Phase 2A planned decoder"
...
echo "[2/2] Training JEPA planner and decoding through frozen Phase 1 decoder"
LATENT_ARGS=()
...
"$PYTHON_BIN" -m sketchimage_jepa.phase2_planned_decoder \
...
echo
echo "Phase 2A planned decoder finished: $OUTPUT_DIR"
