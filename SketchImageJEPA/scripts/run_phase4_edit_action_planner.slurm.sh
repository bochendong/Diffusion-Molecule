#!/bin/bash
#SBATCH --job-name=sketchimage-phase4
#SBATCH --account=def-hup-ab
#SBATCH --gpus=nvidia_h100_80gb_hbm3_1g.10gb:1
#SBATCH --mem=64G
#SBATCH --time=10:00:00
#SBATCH --cpus-per-task=8
#SBATCH --output=./sketchimage-phase4-%j.log
#SBATCH --error=./sketchimage-phase4-%j.log
...
echo "run_name=${SKETCHIMAGE_RUN_NAME:-phase4_edit_action_planner_2048_seed${SKETCHIMAGE_SEED:-7}}"
