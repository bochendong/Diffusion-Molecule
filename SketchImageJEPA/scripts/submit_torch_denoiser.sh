...
export SKETCHIMAGE_DECODER_MODE="${SKETCHIMAGE_DECODER_MODE:-retrieval}"
...
echo "  torch_hard_negative_loss_weight=$SKETCHIMAGE_TORCH_HARD_NEGATIVE_LOSS_WEIGHT"
echo "  torch_hard_negative_margin=$SKETCHIMAGE_TORCH_HARD_NEGATIVE_MARGIN"
...
if [[ "$SKETCHIMAGE_DECODER_MODE" != "retrieval" ]]; then
  ...
  echo "  generative_novelty_bonus=$SKETCHIMAGE_GENERATIVE_NOVELTY_BONUS"
fi
