#!/usr/bin/env bash
# Submit Phase 5B shared-latent joint SMILES/sketch decoder to Slurm.
...
TIME="${SKETCHSMILES_SLURM_TIME:-06:00:00}"
MEM="${SKETCHSMILES_SLURM_MEM:-48G}"
CPUS="${SKETCHSMILES_SLURM_CPUS:-4}"
GPU_PROFILE="${SKETCHSMILES_GPU_PROFILE:-h100_10gb_mig}"
JOB_NAME="${SKETCHSMILES_SLURM_JOB_NAME:-sketchsmiles-5b}"
...
export SKETCHSMILES_RUN_NAME="${SKETCHSMILES_RUN_NAME:-phase5b_joint_decoder_seed${SKETCHSMILES_SEED:-7}}"
...
RUN_SCRIPT="${SKETCHSMILES_RUN_SCRIPT:-scripts/run_phase5b_joint_decoder.sh}"
...
echo "Submitting SketchSMILES Phase 5B:"
