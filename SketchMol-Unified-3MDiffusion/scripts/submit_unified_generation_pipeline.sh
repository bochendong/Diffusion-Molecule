...
case "$RESOURCE_PROFILE" in
  economy)
    ...
    DEFAULT_TRAIN_CPUS="1"
    DEFAULT_TRAIN_MEM="8G"
    DEFAULT_TRAIN_TIME="01:00:00"
    ;;
  throughput_40gb)
...
export SMU3M_PRIOR_LOSS_WEIGHT="${SMU3M_PRIOR_LOSS_WEIGHT:-0.05}"
export SMU3M_SOURCE_REGRET_LOSS_WEIGHT="${SMU3M_SOURCE_REGRET_LOSS_WEIGHT:-0.35}"
export SMU3M_SOURCE_REGRET_MARGIN="${SMU3M_SOURCE_REGRET_MARGIN:-0.0}"
export SMU3M_SOURCE_RADIUS_LOSS_WEIGHT="${SMU3M_SOURCE_RADIUS_LOSS_WEIGHT:-0.10}"
export SMU3M_SOURCE_RADIUS_MARGIN="${SMU3M_SOURCE_RADIUS_MARGIN:-0.05}"
export SMU3M_SOURCE_SIMILARITY_WEIGHT_FLOOR="${SMU3M_SOURCE_SIMILARITY_WEIGHT_FLOOR:-0.25}"
export SMU3M_SOURCE_FINGERPRINT_PRIOR_BLEND="${SMU3M_SOURCE_FINGERPRINT_PRIOR_BLEND:-0.85}"
export SMU3M_FINGERPRINT_GUARD_LOSS_WEIGHT="${SMU3M_FINGERPRINT_GUARD_LOSS_WEIGHT:-0.50}"
export SMU3M_FINGERPRINT_GUARD_MARGIN="${SMU3M_FINGERPRINT_GUARD_MARGIN:-0.02}"
export SMU3M_SOURCE_RESIDUAL_RADIUS_MULTIPLIER="${SMU3M_SOURCE_RESIDUAL_RADIUS_MULTIPLIER:-0.0}"
export SMU3M_SOURCE_RESIDUAL_RADIUS_MARGIN="${SMU3M_SOURCE_RESIDUAL_RADIUS_MARGIN:-0.0}"
export SMU3M_SOURCE_RESIDUAL_MIN_RADIUS="${SMU3M_SOURCE_RESIDUAL_MIN_RADIUS:-0.0}"
...
export SMU3M_MIN_EDIT_SOURCE_TANIMOTO="${SMU3M_MIN_EDIT_SOURCE_TANIMOTO:-0.4}"
export SMU3M_REQUIRE_EDIT_QUALITY_COLUMNS="${SMU3M_REQUIRE_EDIT_QUALITY_COLUMNS:-1}"
export SMU3M_REQUIRE_EVAL_ORACLE_STRICT="${SMU3M_REQUIRE_EVAL_ORACLE_STRICT:-1}"
...
echo "  pairing_strategy=$SMMED_PAIRING_STRATEGY"
echo "  source_neighbor_tanimoto_range=[$SMMED_SOURCE_NEIGHBOR_MIN_TANIMOTO,$SMMED_SOURCE_NEIGHBOR_MAX_TANIMOTO]"
echo "  condition_candidate_diagnostics=$SMMED_CONDITION_CANDIDATE_DIAGNOSTICS"
echo "  oracle_filter_splits=$SMMED_ORACLE_FILTER_SPLITS"
echo "  min_edit_source_tanimoto=$SMU3M_MIN_EDIT_SOURCE_TANIMOTO"
echo "  require_edit_quality_columns=$SMU3M_REQUIRE_EDIT_QUALITY_COLUMNS"
echo "  require_eval_oracle_strict=$SMU3M_REQUIRE_EVAL_ORACLE_STRICT"
...
echo "  source_regret_loss_weight=$SMU3M_SOURCE_REGRET_LOSS_WEIGHT"
echo "  source_regret_margin=$SMU3M_SOURCE_REGRET_MARGIN"
echo "  source_radius_loss_weight=$SMU3M_SOURCE_RADIUS_LOSS_WEIGHT"
echo "  source_radius_margin=$SMU3M_SOURCE_RADIUS_MARGIN"
echo "  source_similarity_weight_floor=$SMU3M_SOURCE_SIMILARITY_WEIGHT_FLOOR"
echo "  source_fingerprint_prior_blend=$SMU3M_SOURCE_FINGERPRINT_PRIOR_BLEND"
echo "  fingerprint_guard_loss_weight=$SMU3M_FINGERPRINT_GUARD_LOSS_WEIGHT"
echo "  fingerprint_guard_margin=$SMU3M_FINGERPRINT_GUARD_MARGIN"
echo "  source_residual_radius_multiplier=$SMU3M_SOURCE_RESIDUAL_RADIUS_MULTIPLIER"
echo "  source_residual_radius_margin=$SMU3M_SOURCE_RESIDUAL_RADIUS_MARGIN"
echo "  source_residual_min_radius=$SMU3M_SOURCE_RESIDUAL_MIN_RADIUS"
