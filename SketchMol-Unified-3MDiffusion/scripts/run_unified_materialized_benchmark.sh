...
METHODS="${SMU3M_BENCHMARK_METHODS:-source_identity,scaffold_property_retrieval,edit_latent_global_retrieval,edit_latent_scaffold_retrieval,edit_latent_scaffold_source_rerank,target_oracle}"
...
SOURCE_SIMILARITY_WEIGHT="${SMU3M_BENCHMARK_SOURCE_SIMILARITY_WEIGHT:-0.25}"
