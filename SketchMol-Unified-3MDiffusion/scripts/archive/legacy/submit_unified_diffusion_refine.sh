...
ANCHOR_OUTPUT_DIR="${SMU3M_SOURCEANCHOR_OUTPUT_DIR:-SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_source_neighbor_sourceanchor_v1}"
export SMU3M_OUTPUT_DIR="${SMU3M_OUTPUT_DIR:-$BASE_OUTPUT_DIR}"
export SMU3M_BASE_DIFFUSION_DIR="${SMU3M_BASE_DIFFUSION_DIR:-$BASE_OUTPUT_DIR/latent_diffusion}"
export SMU3M_DIFFUSION_DIR="${SMU3M_DIFFUSION_DIR:-$ANCHOR_OUTPUT_DIR/latent_diffusion}"
export SMU3M_EVAL_LATENT_DIR="${SMU3M_EVAL_LATENT_DIR:-$ANCHOR_OUTPUT_DIR/eval_latent}"
...
export SMU3M_ALLOW_INCOMPATIBLE_RESUME_WEIGHTS="${SMU3M_ALLOW_INCOMPATIBLE_RESUME_WEIGHTS:-1}"
...
echo "  anchor_output_dir=$ANCHOR_OUTPUT_DIR"
echo "  diffusion_dir=$SMU3M_DIFFUSION_DIR"
echo "  eval_latent_dir=$SMU3M_EVAL_LATENT_DIR"
...
echo "  allow_incompatible_resume_weights=$SMU3M_ALLOW_INCOMPATIBLE_RESUME_WEIGHTS"
...
echo "  diffusion_checkpoint=$SMU3M_DIFFUSION_DIR/latent_diffusion_generation.pt"
echo "  eval_metrics=$SMU3M_EVAL_LATENT_DIR/metrics.json"
