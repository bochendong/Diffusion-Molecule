...
export SMU3M_DIFFUSION_EPOCHS="${SMU3M_DIFFUSION_EPOCHS:-150}"
...
export SMU3M_TRAIN_DIFFUSION_CONNECTOR="${SMU3M_TRAIN_DIFFUSION_CONNECTOR:-0}"
...
echo "  diffusion_epochs=$SMU3M_DIFFUSION_EPOCHS"
