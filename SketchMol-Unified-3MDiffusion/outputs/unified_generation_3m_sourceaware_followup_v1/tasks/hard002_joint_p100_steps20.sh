...
mkdir -p "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/logs" "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_joint_p100_steps20"
exec > >(tee "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/logs/hard002_joint_p100_steps20.log") 2>&1
echo "source-aware follow-up diffusion task: hard002_joint_p100_steps20"
echo "  base_output_dir=SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_sweep_v2/hard002_head"
echo "  prior_loss_weight=1.0"
echo "  train_diffusion_connector=1"
echo "  sample_steps=20"
echo "  extra_epochs=20"
echo "  output_dir=SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_joint_p100_steps20"
...
export SMU3M_DIFFUSION_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_joint_p100_steps20/latent_diffusion"
...
export SMU3M_EVAL_LATENT_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_joint_p100_steps20/eval_latent"
export SMU3M_PRIOR_LOSS_WEIGHT="1.0"
