...
mkdir -p "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/logs" "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps1"
exec > >(tee "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/logs/hard002_freeze_p000_steps1.log") 2>&1
echo "source-aware follow-up diffusion task: hard002_freeze_p000_steps1"
echo "  base_output_dir=SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_sweep_v2/hard002_head"
echo "  prior_loss_weight=0"
echo "  train_diffusion_connector=0"
echo "  sample_steps=1"
echo "  extra_epochs=5"
echo "  output_dir=SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps1"
...
export SMU3M_DIFFUSION_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps1/latent_diffusion"
...
export SMU3M_EVAL_LATENT_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps1/eval_latent"
export SMU3M_PRIOR_LOSS_WEIGHT="0"
export SMU3M_TRAIN_DIFFUSION_CONNECTOR="0"
export SMU3M_EVAL_SAMPLE_STEPS="1"
export SMU3M_DIFFUSION_EXTRA_EPOCHS="5"
