...
mkdir -p "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/logs" "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps20"
exec > >(tee "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/logs/hard002_freeze_p000_steps20.log") 2>&1
echo "source-aware follow-up diffusion task: hard002_freeze_p000_steps20"
...
echo "  extra_epochs=5"
echo "  output_dir=SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps20"
...
export SMU3M_DIFFUSION_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps20/latent_diffusion"
...
export SMU3M_EVAL_LATENT_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_followup_v1/hard002_freeze_p000_steps20/eval_latent"
