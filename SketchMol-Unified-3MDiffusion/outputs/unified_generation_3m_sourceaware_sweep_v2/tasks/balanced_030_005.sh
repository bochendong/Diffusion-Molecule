...
exec > >(tee "SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_sweep_v2/logs/balanced_030_005.log") 2>&1
echo "source-aware sweep task: balanced_030_005"
...
echo "  output_dir=SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_sweep_v2/balanced_030_005"
export SMU3M_OUTPUT_DIR="SketchMol-Unified-3MDiffusion/outputs/unified_generation_3m_sourceaware_sweep_v2/balanced_030_005"
