...
STEP="${P32_STEP:?P32_STEP must be exported as 000, 010, 020, or 030}"
...
if [[ "$STEP" == "000" ]]; then
  ADAPTER="$PROJECT/outputs/unified_constraint_agent_common_llm_pilot_v1/model/seed_1703/adapter"
else
