...
"$PY" -m py_compile \
  "$SCRIPT_DIR/graph_repair_protocol.py" \
  "$SCRIPT_DIR/prepare_records.py" \
  "$SCRIPT_DIR/audit_support.py" \
  "$SCRIPT_DIR/train_shared_graph_repair_rl.py" \
  "$SCRIPT_DIR/evaluate_checkpoint.py" \
  "$SCRIPT_DIR/collect_gate.py"
