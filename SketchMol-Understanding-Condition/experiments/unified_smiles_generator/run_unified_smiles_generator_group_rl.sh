...
RL_OBJECTIVE="${SUCC_UNIFIED_RL_OBJECTIVE:-group_pg}"
GRPO_CLIP_EPS="${SUCC_UNIFIED_RL_GRPO_CLIP_EPS:-0.2}"
GRPO_UPDATE_EPOCHS="${SUCC_UNIFIED_RL_GRPO_UPDATE_EPOCHS:-1}"
...
args=(
  ...
  --rl-objective "$RL_OBJECTIVE"
  --grpo-clip-eps "$GRPO_CLIP_EPS"
  --grpo-update-epochs "$GRPO_UPDATE_EPOCHS"
