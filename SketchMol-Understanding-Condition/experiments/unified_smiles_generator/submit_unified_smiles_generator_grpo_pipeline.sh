...
export SUCC_UNIFIED_CONDITION_LAYOUT="${SUCC_UNIFIED_CONDITION_LAYOUT:-unified}"
...
SUCC_UNIFIED_CONDITION_LAYOUT='${SUCC_UNIFIED_CONDITION_LAYOUT}' \
...
echo "  condition_layout=$SUCC_UNIFIED_CONDITION_LAYOUT"
