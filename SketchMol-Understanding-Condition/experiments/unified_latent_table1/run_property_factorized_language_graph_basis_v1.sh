#!/usr/bin/env bash
# Run one bounded property-factorized language-to-graph representation probe.
...
PYTHON_BIN="${SUCC_PROPERTY_BASIS_PYTHON:-/home/bdong/.venvs/molscribe_overlay/bin/python}"
DEP_OVERLAY="${SUCC_PROPERTY_BASIS_DEP_OVERLAY:-/scratch/bdong/venvs/uca_common_llm_overlay}"
...
OUTPUT_DIR="${SUCC_PROPERTY_BASIS_OUTPUT_DIR:-$SHARED_PROJECT_DIR/outputs/property_factorized_language_graph_basis_v1/seed_2051}"
PROTOCOL="$SCRIPT_DIR/property_factorized_language_graph_basis_v1_preregistration.json"
...
exec "$PYTHON_BIN" "$SCRIPT_DIR/property_factorized_language_graph_basis_v1.py" \
