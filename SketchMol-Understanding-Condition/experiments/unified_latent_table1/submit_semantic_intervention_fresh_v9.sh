...
echo "candidate_contract=3_replicates_x_6_arms_x_24_fresh_conditions_x_exact_20"
...
echo "result=$SHARED_REPO_DIR/SketchMol-Understanding-Condition/outputs/semantic_intervention_fresh_v9/seed_2121/gate/gate_summary.json"
