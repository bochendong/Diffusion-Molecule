#!/usr/bin/env python
"""Train pair-aware image encoder v2.1."""
...
from sketchmol_understanding_condition.pairaware_image_encoder import train_pairaware_image_encoder
...
def main() -> None:
    ...
    summary = train_pairaware_image_encoder(
