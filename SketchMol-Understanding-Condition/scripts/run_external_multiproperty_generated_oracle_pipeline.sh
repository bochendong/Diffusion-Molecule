...
SMILES_COLUMNS="${SUCC_ORACLE_SMILES_COLUMNS:-generated_smiles,source_smiles,target_smiles,input_smiles,output_smiles,input,output,source,original_smiles,optimized_smiles,smiles,SMILES,canonical_smiles}"
