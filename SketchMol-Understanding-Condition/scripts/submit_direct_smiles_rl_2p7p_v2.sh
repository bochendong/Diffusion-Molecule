...
JOB_NAME="${SUCC_DIRECT_RL_SLURM_JOB_NAME:-succ-direct-smiles-2p7p-v2-rl}"
...
echo "  output_dir=${SUCC_DIRECT_RL_OUTPUT_DIR:-SketchMol-Understanding-Condition/outputs/direct_smiles_denovo_2p7p_v2_rl_v1}"
