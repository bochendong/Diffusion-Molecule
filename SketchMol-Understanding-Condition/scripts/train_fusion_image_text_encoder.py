#!/usr/bin/env python
"""Train image+text fusion encoder v2.2."""
...
from sketchmol_understanding_condition.fusion_image_text_encoder import train_fusion_image_text_encoder
...
def main() -> None:
    ...
    summary = train_fusion_image_text_encoder(
