...
TABLE_MISSING_ORACLE_POLICY="${SUCC_MOLEDIT_TABLE_MISSING_ORACLE_POLICY:-fail}"
TABLE_INCLUDE_EMPTY_TABLE1="${SUCC_MOLEDIT_TABLE_INCLUDE_EMPTY_TABLE1:-0}"
TABLE_REQUIRE_TABLE1_COVERAGE="${SUCC_MOLEDIT_TABLE_REQUIRE_TABLE1_COVERAGE:-0}"
TABLE_RDKIT_MODULES="${SUCC_MOLEDIT_TABLE_RDKIT_MODULES:-gcc/12.3 rdkit/2024.09.6}"
TABLE_TIME="${SUCC_MOLEDIT_TABLE_SLURM_TIME:-02:00:00}"
...
if [[ "$TABLE_INCLUDE_EMPTY_TABLE1" == "1" ]]; then
  TABLE_CMD+=(--include-empty-table1)
fi
if [[ "$TABLE_REQUIRE_TABLE1_COVERAGE" == "1" ]]; then
  TABLE_CMD+=(--require-table1-coverage)
fi
...
echo "  include_empty_table1=$TABLE_INCLUDE_EMPTY_TABLE1"
echo "  require_table1_coverage=$TABLE_REQUIRE_TABLE1_COVERAGE"
if [[ -n "$TABLE_DEPENDENCY" ]]; then
