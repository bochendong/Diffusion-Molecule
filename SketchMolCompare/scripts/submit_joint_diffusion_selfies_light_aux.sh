#!/usr/bin/env bash
# Submit Route B with SELFIES tokens and lighter image/CLIP auxiliary losses.
...
export SKETCHMOL_JOINT_RUN_NAME="${SKETCHMOL_JOINT_RUN_NAME:-sketchmol_compare_joint_selfies_light_aux_seed${SEED}}"
...
export SKETCHMOL_JOINT_IMAGE_LOSS_WEIGHT="${SKETCHMOL_JOINT_IMAGE_LOSS_WEIGHT:-0.25}"
export SKETCHMOL_JOINT_CLIP_LOSS_WEIGHT="${SKETCHMOL_JOINT_CLIP_LOSS_WEIGHT:-0.02}"
...
echo "SketchMolCompare -> Route B SELFIES light-aux joint diffusion"
