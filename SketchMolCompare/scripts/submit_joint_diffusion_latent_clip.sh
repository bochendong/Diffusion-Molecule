#!/usr/bin/env bash
# Submit Route B with a shared latent and CLIP-style image/token alignment loss.
...
export SKETCHMOL_JOINT_RUN_NAME="${SKETCHMOL_JOINT_RUN_NAME:-sketchmol_compare_joint_latent_clip_seed${SEED}}"
...
echo "SketchMolCompare -> Route B latent-CLIP joint diffusion"
