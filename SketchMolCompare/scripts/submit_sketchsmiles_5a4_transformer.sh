#!/usr/bin/env bash
# Submit the current best OCR-free SketchSMILES Transformer decoder.
...
export SKETCHSMILES_RUN_NAME="${SKETCHSMILES_RUN_NAME:-sketchmol_compare_phase5a4_seed${SEED}}"
...
echo "SketchMolCompare -> SketchSMILES Phase 5A-4"
echo "  cwd=$PWD"
